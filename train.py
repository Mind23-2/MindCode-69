...
if __name__ == '__main__':
    ...
    # net = ResNet_BAM.ResidualNet("ImageNet", 50, cfg.num_classes, "CBAM")
    ...
    ckpoint_cb = ModelCheckpoint(prefix="train_resnet50-bam_" + args_opt.dataset_name, directory=ckpt_save_dir,
                                 config=config_ck)
    loss_cb = LossMonitor()
